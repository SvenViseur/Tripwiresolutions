...
if [ "$TheTicketType" != "password" ]; then
  echo "ERROR: This ticket is not a bof type password ticket. The files attached to the ticket do not match the expected "
