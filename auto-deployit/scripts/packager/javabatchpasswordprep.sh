...
# dexa  # 20/02/2019  # 1.2.0 # Vervang StapDoel door DeployIT_Stap_Doel
# lekri # 12/11/2021  # 1.2.1 # ondersteuning ACC & SIM TraceIT/4me
#       #             #       #
#################################################################
#
ScriptName="javabatchpasswordprep.sh"
ScriptVersion="1.2.1"
...
if [ "$TheTicketType" != "password" ]; then
  echo "ERROR: This ticket is not a Javabatch type password ticket. The files attached to the ticket do not match the expected "
