...
# dexa # jul/2016    # toev call ripple up
...
# dexa # 17/01/2017  # ONDERSTEUN-1070: delete
...
ScriptName="jbosspasswordprep.sh"
...
if [ "$TheTicketType" != "password" ]; then
  echo "ERROR: This ticket is not a JBoss type password ticket. The files attached to the ticket do not match the expected "
