...
ActionType="javabatch-config-prep"
MaakTmpTicketFolder
cd ${TmpTicketFolder}
...
if [ ${TheTicketType} != "config" ]; then
  echo "Error: This ticket is not a javabatch config-type. The files attached to the ticket do not match the expected "
