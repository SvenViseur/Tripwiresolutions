...
# Change history
#################################################################
# dexa # sep/2016    # toev call initial_settings.sh
# dexa # 2/11/2016   # skip encryption step omdat die niet
...
ScriptName="jbossconfigverify.sh"
